...
*Logistic growth modeling suggests CTA ridership will rebound sharply but level off around **85–90% of pre-COVID levels by 2035**. Projections should be interpreted with caution given the limited post-COVID data available.*
